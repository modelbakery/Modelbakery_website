...
You may have heard of the Pareto Principle, but knowing how would you utilize its advantages can seriously save your time. By nature of sales businesses, in general, have an urgency to secure as many leads as quickly as possible due to the market competition. Therefore, abstracting a target customer from highly complex and overload of information in customers' demographics, desire, and product categories, the power of the leading score can be significant. 

In this post, I like to introduce a simple statistical RFM metrics and further discuss the essence of scoring. The aim is to retain RFM score from revenue view point with acceptable distribution and each purchasing behvaiour groups similar in size. To put RFM into marketing perspectives, it is a valuable tool when marketers wants a quick and success. This matric will almost always warrant quick and profitable results. 
