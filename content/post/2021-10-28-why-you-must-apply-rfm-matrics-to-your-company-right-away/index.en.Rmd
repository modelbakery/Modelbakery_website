...
cust_dup_tbl %>% 
  ...
  theme_tq()
```
The mean, median and other sample statistics had trouble to explain this proportional difference of these two regions. I believe this is where it gets tricky. Repeated same-day purchase records themselves are not a meaningful feature, but due to "confonding" effects it behaviour as if it has some predictive power between the two groups. Perhaps it is the __accessibility__ upon purchase act as a confounder between monetary value and same-day purchase. 
