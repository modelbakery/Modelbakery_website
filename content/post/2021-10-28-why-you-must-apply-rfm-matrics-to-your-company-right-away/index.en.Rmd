...
What is a good response rate? The response rate varies with industries, company size, type of campaign, time and more. The ability to retain engagement customers is a major concern for many businesses. However, retention is not the only dimension of our interest; the revenue stream associated with these actively engaging or persuadable customer is another factor influencing customer profitability. 
...
We noticed the average campaign response rate is 9.4%. Under the assumption that the company is either retail or ecommerce business the value sits on a good hand. This value to could also mean the percentage of persuaders. 

Questions of ask:
* Campaign responders contribute higher value to the company than the non-responders?
* When has the promotion began? What is the average time decay (rate) upon campagin effect expiration?
...
* The monetary value distribution of campaign respond customer is symmetric with low variance; desirable to work with and thus predict. 
  + How many of these customers can we retain for x period of month or years?

* This difference in mean value of monetary/sales (shift in distribution) fostered by campaign activity?
  + Having time series visualisation and STL decomposition comparison of campaign respond customer and non-responded customer (benchmark) would supply more information on pricing control upon campaign budgeting. 



## 5.0 RFM feature engineering 

Main dish for this post umm..

Often, in most of the quantitative analysis and toward predictions, having too many zero values can effect on the transformation and its distribution. For this reason, I have added 1 value to all customers which takes account of customer has purchased the day we compute this metric; named it as recency days. This is great trick in case we would like to do log transform later on our analysis :) 
...
In full honesty this few lines of code + ntile() function is all we need for RFM scoring. 
