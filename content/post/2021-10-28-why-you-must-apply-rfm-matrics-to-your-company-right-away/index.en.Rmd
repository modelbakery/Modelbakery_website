...
```
Quick statistical comparison on monetary value is not significant enough to flag (mark) for further analysis.
...
However, the density distribution of monetary value of these groups 
